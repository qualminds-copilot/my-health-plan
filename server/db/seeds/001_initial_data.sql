...
-- Insert diagnoses
INSERT INTO diagnoses (id, diagnosis_code, diagnosis_name, description, icd_10_code, category, severity, created_at) VALUES
...
-- Insert DRG codes
INSERT INTO drg_codes (id, drg_code, drg_description, category, weight, los_geometric_mean, created_at) VALUES
...
INSERT INTO members (id, member_number, first_name, last_name, date_of_birth, gender, phone, email, address, insurance_group, policy_number, created_at, updated_at) VALUES
(1, 'MEM001', 'Robert', 'Abbott', '1985-03-15', 'M', NULL, NULL, NULL, 'Silvermine', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'MEM002', 'Samuel', 'Perry', '1978-07-22', 'M', NULL, NULL, NULL, 'Evernorth', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'MEM003', 'Kate', 'Sawyer', '1992-11-08', 'F', NULL, NULL, NULL, 'Cascade I', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(4, 'MEM004', 'Laura', 'Smith', '1981-05-30', 'F', NULL, NULL, NULL, 'Palicade R', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(5, 'MEM005', 'Renee', 'Rutherford', '1975-09-12', 'F', NULL, NULL, NULL, 'Trinity Oal', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6, 'MEM006', 'Mike', 'Andrews', '1988-12-04', 'M', NULL, NULL, NULL, 'LumenPoi', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, 'MEM007', 'James', 'Oliver', '1973-04-18', 'M', NULL, NULL, NULL, 'St. Aureliu', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, 'MEM008', 'John', 'Emerson', '1990-08-25', 'M', NULL, NULL, NULL, 'Cobalt Bay', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, 'MEM009', 'Samuel', 'Perry', '1982-01-14', 'M', NULL, NULL, NULL, 'Trinity Oal', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10, 'MEM010', 'Laura', 'Smith', '1987-06-09', 'F', NULL, NULL, NULL, 'St. Aureliu', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert sample providers
INSERT INTO providers (id, provider_code, provider_name, provider_type, address, phone, fax, email, npi, tax_id, contract_status, created_at, updated_at) VALUES
...
-- Insert sample users (all using the same password: 'password123')
...
INSERT INTO priority_levels (id, priority_code, priority_name, description, color_code, sort_order, is_active) VALUES
...
-- Insert review types
INSERT INTO review_types (id, review_code, review_name, description, typical_duration_hours, is_active) VALUES
...
-- Insert status types
INSERT INTO status_types (id, status_code, status_name, description, color_code, is_final, sort_order, is_active) VALUES
...
(1, '2025OP000389', 1, 1, 1, 1, 'Inpatient', 'Initial Review', 'High', '2025-06-16 01:15:00', '2025-06-15', NULL, 3, '2025-06-16 01:15:00', NULL, 'Pending', '637', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-15 00:00:00', CURRENT_TIMESTAMP),
(2, '2025OP000387', 2, 2, 2, 2, 'Inpatient', 'Initial Review', 'High', '2025-06-16 02:30:00', '2025-06-16', NULL, 3, '2025-06-16 02:30:00', NULL, 'Pending', '291', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-14 00:00:00', CURRENT_TIMESTAMP),
(3, '2025OP000928', 3, 3, 3, 3, 'Inpatient', 'Concurrent Review', 'High', '2025-06-16 03:45:00', '2025-06-15', NULL, 3, '2025-06-16 03:45:00', NULL, 'Pending', '687', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-13 00:00:00', CURRENT_TIMESTAMP),
(4, '2025OP000278', 4, 4, 3, 4, 'Inpatient', 'Initial Review', 'High', '2025-06-16 04:00:00', '2025-06-16', NULL, 3, '2025-06-16 04:00:00', NULL, 'Pending', '688', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-12 00:00:00', CURRENT_TIMESTAMP),
(5, '2025OP000378', 5, 5, 1, 1, 'Inpatient', 'Initial Review', 'High', '2025-06-16 05:15:00', '2025-06-15', NULL, 3, '2025-06-16 05:15:00', NULL, 'Pending', '637', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-11 00:00:00', CURRENT_TIMESTAMP),
(6, '2025OP000312', 6, 6, 1, 5, 'Inpatient', 'Concurrent Review', 'High', '2025-06-16 06:30:00', '2025-06-16', NULL, 3, '2025-06-16 06:30:00', NULL, 'Appeal', '638', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-10 00:00:00', CURRENT_TIMESTAMP),
(7, '2025OP000152', 7, 7, 6, 6, 'Inpatient', 'Concurrent Review', 'Medium', '2025-06-16 07:45:00', '2025-06-15', NULL, 3, '2025-06-16 07:45:00', NULL, 'In Review', '602', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-16 00:00:00', CURRENT_TIMESTAMP),
(8, '2025OP000369', 8, 8, 4, 7, 'Inpatient', 'Initial Review', 'Medium', '2025-06-16 08:00:00', '2025-06-16', NULL, 3, '2025-06-16 08:00:00', NULL, 'Pending', '191', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-15 00:00:00', CURRENT_TIMESTAMP),
(9, '2025OP000189', 9, 5, 5, 8, 'Inpatient', 'Concurrent Review', 'Medium', '2025-06-16 09:15:00', '2025-06-15', NULL, 3, '2025-06-17 09:00:00', NULL, 'Pending', '690', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-14 00:00:00', CURRENT_TIMESTAMP),
(10, '2025OP000390', 10, 7, 1, 1, 'Inpatient', 'Initial Review', 'Medium', '2025-06-16 10:30:00', '2025-06-16', NULL, 3, '2025-06-18 10:00:00', NULL, 'In Review', '637', NULL, NULL, NULL, NULL, NULL, NULL, '2025-06-13 00:00:00', CURRENT_TIMESTAMP);

-- Reset sequences to match the inserted data
SELECT setval('diagnoses_id_seq', 6, true);
SELECT setval('drg_codes_id_seq', 8, true);
SELECT setval('members_id_seq', 10, true);
SELECT setval('providers_id_seq', 8, true);
SELECT setval('users_id_seq', 4, true);
SELECT setval('priority_levels_id_seq', 3, true);
SELECT setval('review_types_id_seq', 4, true);
SELECT setval('status_types_id_seq', 6, true);
SELECT setval('authorizations_id_seq', 10, true);
